export default {
  ...
  dictCancelUploadConfirmation:
    "¿Está seguro de que desea cancelar esta carga?",
  dictDefaultMessage: "Suelta archivos aquí para subirlos",
  dictFallbackMessage:
    "Su navegador no admite cargas de archivos de arrastrar y soltar.",
  dictFallbackText:
    "Por favor, utilice el siguiente formulario de reserva para cargar sus archivos como en los viejos tiempos.",
